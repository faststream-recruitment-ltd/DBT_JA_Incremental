...
select
    ...
    cast(fee_rate as {{ dbt_utils.type_numeric() }}) as fee_rate,
    cast(fee_estimatedTotal as {{ dbt_utils.type_numeric() }}) as fee_estimatedTotal,
    ...
    cast(company_status_statusId as {{ dbt_utils.type_bigint() }})  as company_status_statusId,
    cast(company_companyId as {{ dbt_utils.type_bigint() }})  as companyId,    
    ...
    category,
    cast(closedAt as timestamp)  as closedAt,
