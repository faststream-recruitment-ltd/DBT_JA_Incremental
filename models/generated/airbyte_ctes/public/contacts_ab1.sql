...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['officeAddress', 'name'], ['name']) }} as office_name,
    ...
    {{ json_extract_scalar('_airbyte_data', ['officeAddress', 'postalCode'], ['postalcCde']) }} as postalcode,
