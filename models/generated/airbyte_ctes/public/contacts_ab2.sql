...
select
    ...
    cast(original_contactid as {{ dbt_utils.type_bigint() }}) as original_contactid,
    cast(previous_contactid as {{ dbt_utils.type_bigint() }}) as previous_contactid,
    ...
    cast(reportsTo_contactid as {{ dbt_utils.type_bigint() }}) as reportsTo_contactid, 
