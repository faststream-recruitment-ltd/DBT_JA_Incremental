...
select
    candidateid,
    appid,
    cast(candidate_updatedat as timestamp with time zone) as candidate_updatedat,
    ...
    cast(application_createdAt as timestamp with time zone) as application_createdAt,
    cast(application_updatedAt as timestamp with time zone) as application_updatedAt,
