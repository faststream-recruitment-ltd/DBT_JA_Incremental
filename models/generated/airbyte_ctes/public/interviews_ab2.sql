...
select
    ...
    cast(startAt as timestamp) as startAt,
    cast(endAt as timestamp) as endAt,
    ...
    cast(interviewee_job_jobId as {{ dbt_utils.type_bigint() }}) as interviewee_job_jobId,
    cast(interviewee_job_status_name as {{ dbt_utils.type_string() }}) as interviewee_job_status_name,
    cast(interviewee_job_status_statusId as {{ dbt_utils.type_bigint() }}) as interviewee_job_status_statusId,
    ...
    cast(interviewee_candidate_status_statusId as {{ dbt_utils.type_bigint() }}) as interviewee_candidate_status_statusId,
    ...
    cast(interviewee_candidate_candidateId as {{ dbt_utils.type_bigint() }}) as interviewee_candidate_candidateId,
    ...
    cast(interviewee_applicationId as {{ dbt_utils.type_bigint() }}) as interviewee_applicationId,
    _airbyte_ab_id,
    _airbyte_emitted_at,
